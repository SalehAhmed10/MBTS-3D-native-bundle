...
const UpdateShoppingListModal = ({
  showUpdateShoppingListModal,
  lineItems,
  onChangeQuantity,
  onCheckBoxPress,
  onSavePress,
  ...
  return (
    <>
      <Modal
        isVisible={showUpdateShoppingListModal}
        animationIn="fadeIn"
        ...
        <View style={styles.container}>
          ...
          />
          <Text style={styles.heading}>Update Shopping List</Text>
          <FlatList
            data={lineItems}
...
export default UpdateShoppingListModal;
